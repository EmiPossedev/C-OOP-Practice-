...
public:
    // Agrego constructor por defecto
    Cilindro(): m_altura(0), m_radio(0) {}
    
    // Constructor con parámetros
    Cilindro(float altura, float radio): m_altura(altura), m_radio(radio) {}
    
    void AsignarDatos(float altura, float radio) {
        m_altura = altura;
        m_radio = radio;
    }
